## This script is from https://community.spiceworks.com/topic/2127465-windows-10-powershell-take-ownership-of-a-registry-key
## I have changed the registry key to 
...
# Change Permissions for the trusted installer account
#$regKey = [Microsoft.Win32.Registry]::LocalMachine.OpenSubKey("SYSTEM\CurrentControlSet\Control\DmaSecurity\AllowedBuses",[Microsoft.Win32.RegistryKeyPermissionCheck]::ReadWriteSubTree,[System.Security.AccessControl.RegistryRights]::ChangePermissions)
#$regACL = $regKey.GetAccessControl()
#$regRule = New-Object System.Security.AccessControl.RegistryAccessRule ("NT Service\TrustedInstaller","FullControl","None","None","Allow")
#$regACL.SetAccessRule($regRule)
#$regKey.SetAccessControl($regACL)